...
python . -download-data -interval-list=1h -log-level=DEBUG -verbose
...
python . -download-data -interval-list=30m -log-level=DEBUG -verbose
python . -batch-training -calc-rsi -normalize -no-tune -n-jobs=20 \
-symbol-list=BTCUSDT,ETHUSDT,BNBUSDT,XRPUSDT,ADAUSDT,DOGEUSDT,SOLUSDT,TRXUSDT,DOTUSDT,MATICUSDT,LTCUSDT,BCHUSDT,AVAXUSDT,XLMUSDT,LINKUSDT,XMRUSDT,UNIUSDT,ATOMUSDT \
...
python . -download-data -interval-list=15m -log-level=DEBUG -verbose
python . -batch-training -calc-rsi -normalize -no-tune -n-jobs=20 \
-symbol-list=BTCUSDT,ETHUSDT,BNBUSDT,XRPUSDT,ADAUSDT,DOGEUSDT,SOLUSDT,TRXUSDT,DOTUSDT,MATICUSDT,LTCUSDT,BCHUSDT,AVAXUSDT,XLMUSDT,LINKUSDT,XMRUSDT,UNIUSDT,ATOMUSDT \
-interval-list=15m -estimator-list=knn -stop-loss-list=1.0 \
-numeric-features=volume,quote_asset_volume,number_of_trades,taker_buy_base_asset_volume,taker_buy_quote_asset_volume \
-regression-PnL-list=60 -regression-times-list=0 -start-train-date=2021-01-01 -start-test-date=2023-01-01
...
-numeric-features=volume,quote_asset_volume,number_of_trades,taker_buy_base_asset_volume,taker_buy_quote_asset_volume \
-regression-PnL-list=72 -regression-times-list=0 -start-train-date=2022-01-01 -start-test-date=2023-01-01

python . -download-data -interval-list=1m -log-level=DEBUG -verbose
python . -batch-training -calc-rsi -normalize -no-tune -n-jobs=20 \
-symbol-list=BTCUSDT,ETHUSDT,BNBUSDT,XRPUSDT,ADAUSDT,DOGEUSDT,SOLUSDT,TRXUSDT,DOTUSDT,MATICUSDT,LTCUSDT,BCHUSDT,AVAXUSDT,XLMUSDT,LINKUSDT,XMRUSDT,UNIUSDT,ATOMUSDT \
-interval-list=1m -estimator-list=knn -stop-loss-list=1.0 \
-numeric-features=volume,quote_asset_volume,number_of_trades,taker_buy_base_asset_volume,taker_buy_quote_asset_volume \
-regression-PnL-list=120 -regression-times-list=0 -start-train-date=2022-07-01 -start-test-date=2023-01-01