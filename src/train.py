...
def start_train_engine(symbol,
  ...
  model_name = save_model(symbol, interval, final_model, setup, estimator, stop_loss, regression_times, times_regression_profit_and_loss)
...
def exec_simule_trading(symbol,
  ...
  experiment, model = load_model(symbol, interval, estimator, stop_loss, regression_times, )
